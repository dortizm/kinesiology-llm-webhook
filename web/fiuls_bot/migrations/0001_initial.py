    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_chat', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='telegram_states', to='fiuls_bot.telegramchat')),
                ('telegram_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='telegram_states', to='fiuls_bot.telegramuser')),
            ],
            options={
